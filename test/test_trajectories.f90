...
call add_node(tra, 4._dp, [4._dp])
call assert_equal(len_dirty(tra), 4, __LINE__)
call save_trajectory(tra)
call assert_almost_equal(tra%t, [1._dp, 2._dp, 3._dp, 4._dp], __LINE__)
call assert_almost_equal(tra%y(1,:), [1._dp, 2._dp, 3._dp, 4._dp], __LINE__)
call assert_false(isdirty(tra), __LINE__)
call getfield(tra, "x", x)
call assert_almost_equal(x, [1._dp, 2._dp, 3._dp, 4._dp], __LINE__)
