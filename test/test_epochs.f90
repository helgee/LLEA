...
ep2 = epoch(2000, 1, 1, hour=12)
call assert_almost_equal(jd2000(ep2), 0.5_dp, __LINE__)
ep2 = epoch(2000, 1, 1, minute=720)
call assert_almost_equal(jd2000(ep2), 0.5_dp, __LINE__)
ep2 = epoch(2000, 1, 1, seconds=43200._dp)
call assert_almost_equal(jd2000(ep2), 0.5_dp, __LINE__)
