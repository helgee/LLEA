...
x = [1._dp, 2._dp, 3._dp]
y = [0._dp, 2._dp, 4._dp]
spl = spline1d_(x, y, k=1, s=real(size(x), kind=dp))
yi = knots(spl)
...
w = [1.00000000e+12_dp, 6.88875973e+02_dp, 4.89314737e+02_dp, 4.26864807e+02_dp, &
     ...
     1.00000000e+12_dp]
spl = spline1d_(x, y, w=w, s=real(size(x), kind=dp))
...
spl = spline1d_(x, y, bc="unknown", err=err)
